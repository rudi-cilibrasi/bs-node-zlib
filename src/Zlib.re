...
[@bs.val] external gzipSyncBase : (Node.Buffer.t) => Node.Buffer.t = "Zlib.gzipSync";
let gzipSync : (Node.Buffer.t) => Node.Buffer.t = (s) => gzipSyncBase(s);

[@bs.val] external gunzipSyncBase : (Node.Buffer.t) => Node.Buffer.t = "Zlib.gunzipSync";
let gunzipSync : (Node.Buffer.t) => Node.Buffer.t = (s) => gunzipSyncBase(s);
